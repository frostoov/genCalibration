...
int ReadWordExt12(ULONG adr)     /* get word from arbitrary address */
{
	char buf[2];
	int Data=0;
	int res=0;
...
int ReadWordExt(ULONG adr)     /* get word from arbitrary address */
{
	char buf[2];
	int Data=0;
	int res=0;
...
void WriteWordExt(ULONG adr, int Data)
{
	char buf[2];
	int res=0;
	int kk=0;
